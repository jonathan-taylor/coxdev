...
This is accomplished by a particular lexical sort which takes all points with equal event times and places those failures with $w_i>0$ in the beginning
of that segment and into a unique cluster.
